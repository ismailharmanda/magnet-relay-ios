...
- Age rating answers are source-controlled as `fastlane/app_rating_config.json` with all content descriptors set to `NONE`, no gambling, no unrestricted web access, and no 17+ flag.
