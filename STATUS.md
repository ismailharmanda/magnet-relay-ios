...
- Age rating answers are source-controlled as `fastlane/app_rating_config.json` with all content descriptors set to `NONE`, no gambling, and no unrestricted web access.
